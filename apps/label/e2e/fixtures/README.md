...
`readme-annotations.json` is the VisTaxa export from [oldvis/image-taxonomy](https://github.com/oldvis/image-taxonomy/blob/main/annotations.json) (400 labeled plates).
